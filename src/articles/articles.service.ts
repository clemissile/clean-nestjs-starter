...
export class ArticlesService {
  private readonly articles: IArticle[] = [
    ...
    },
    {
      ...
      owner: 'paul.bismuth@example.com',
    },
    {
      title: 'Lorem ipsum article 4',
      description:
        'Nulla lacinia finibus nulla non bibendum. Proin ante metus, aliquet quis volutpat at, varius id massa. Praesent convallis aliquam tellus vitae pellentesque. Morbi viverra ipsum neque, vitae pretium nunc commodo tristique. Nulla imperdiet libero eget purus finibus, eget dignissim eros tincidunt. Quisque varius mi sed ipsum pretium accumsan. Proin et nisi augue.',
      owner: 'jane.doe@example.com',
    },
    {
      title: 'Lorem ipsum article 5',
      description:
        'Sed ut sagittis elit, at pulvinar metus. Quisque lectus massa, ultrices vel magna ac, luctus auctor mi. Aenean vulputate ullamcorper sapien at pulvinar. Etiam porta porttitor nulla, vitae elementum nisi pellentesque ut. Vivamus eleifend semper nisi, et efficitur velit malesuada vitae. Maecenas interdum elementum placerat. Aenean non elementum enim, molestie aliquet magna.',
      owner: 'john.doe@example.com',
    },
    {
      title: 'Lorem ipsum article 6',
      description:
        'Phasellus et iaculis leo, eu egestas odio. Nunc non libero vitae elit interdum accumsan vel quis lorem. In vehicula arcu leo, non placerat velit mollis id. In sit amet arcu elementum, suscipit diam quis, efficitur nisi. Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
      owner: 'john.doe@example.com',
    },
  ];
